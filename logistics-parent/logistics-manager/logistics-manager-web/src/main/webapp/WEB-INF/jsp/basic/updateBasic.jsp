...
<div class="formbody">
    ...
    <form action="/basic/saveOrUpdate" method="post">
        ...
        <ul class="forminfo">
            ...
            <li>
                <label>数据名称</label><input name="baseName" type="text" class="dfinput" value="${basicData.baseName}"/><i></i>
            </li>
            <li>
                <label>数据描述</label><input name="baseDesc" type="text" class="dfinput" value="${basicData.baseDesc}"/><i></i>
            </li>
            <li>
                <label>分配类型</label>
                    <div class="vocation">
